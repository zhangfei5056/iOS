...
typedef enum DragDirection{
    DragDirectionNone = 0,
    DragDirectionHorizontal = 1<<0,
    DragDirectionVertical = 1<<1,
}DragDirection;
...
@property (nonatomic, assign) IBOutlet id<LolayGridViewDelegate>   dataDelegate;
...
@property (nonatomic, assign) DragDirection dragDir;
