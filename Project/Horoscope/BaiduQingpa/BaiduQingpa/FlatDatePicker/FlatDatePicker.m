...
-(id)initWithFrame:(CGRect)frame {
    ...
    if ([super initWithFrame:frame]) {
        ...
        self.backgroundColorSelected = [UIColor colorWithWhite:1.000 alpha:0.000];
...
-(id)initWithParentView:(UIView*)parentView {
    ...
    if ([self initWithFrame:CGRectMake(0.0, _parentView.frame.size.height, [[UIScreen mainScreen]bounds].size.width, kFlatDatePickerHeight)]) {
        _datePickerMode = FlatDatePickerModeDate;
